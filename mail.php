...
if (!empty($_POST)) {
$to = 'info@bluewayvanlines.com';
$subject = 'Blueway Van Lines';
...
<body>
<h1>Blueway Van Lines - '.$address.'</h1>
<table>
<caption>Lead Information:</caption>
	...
	<tr>
	 ...
	 <tr>
		<td class="bold">Move To:</td>
		<td>'.$moving_to.'</td>
	</tr>
	 <tr>
		<td class="bold">Move From:</td>
		<td>'.$moving_from.'</td>
	</tr>
</table>';
...
$headers .= "From: Blueway Van Lines <info@bluewayvanlines.com>\r\n";
if($phone!=''||$email!='') {
